...
test('should register bean (class)', (t) => {
    t.plan(1);
    const beanDefinition1 = new BeanDefinition_1.default('test1');
...
test('should register bean and call postConstruct (class)', (t) => {
    t.plan(2);
    const beanDefinition1 = new BeanDefinition_1.default('test6');
...
test('should register bean (object) (prototype)', (t) => {
    t.plan(1);
    const beanDefinition1 = new BeanDefinition_1.default('test3');
...
test('should register bean (class + prototype)', (t) => {
    t.plan(2);
    const beanDefinition1 = new BeanDefinition_1.default('test4');
...
test('Should inject dependencies', (t) => {
    ...
    beanDefinition1.class = '../../testdata/test1';
    beanDefinition1.scope = 'singleton';
    const beanDefinition2 = new BeanDefinition_1.default('test2');
...
test('', (t) => {
    t.plan(2);
    const beanDefinition1 = new BeanDefinition_1.default('test2');
    beanDefinition1.class = '../../testdata/test2';
    beanDefinition1.scope = 'singleton';
    beanDefinition1.properties = [{ value: 'test1' }];
    const beanDefinition2 = new BeanDefinition_1.default('test1');
...
test('initialize should fail on error', (t) => {
    t.plan(1);
    const beanDefinition1 = new BeanDefinition_1.default('test5');
...
test('should throw error if error on post construct', (t) => {
    t.plan(2);
    const beanDefinition1 = new BeanDefinition_1.default('test11');
    beanDefinition1.class = '../../testdata/test11';
    beanDefinition1.scope = 'singleton';
    beanDefinition1.properties = [{
            ref: 'test10'
        }];
    const beanDefinition2 = new BeanDefinition_1.default('test10');
